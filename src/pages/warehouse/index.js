...
import AddUserDrawer from 'src/views/apps/warehouse/AddWarehouseDrawer'
import SidebarEditPeople from 'src/views/apps/warehouse/EditWarehouse'
import { getAllWarehouse } from 'src/api/RequestApi'
import { deleteWarehouse } from 'src/api/RequestApi'
...
const PersonsType = ({ apiData }) => {
  ...
  const handleDelete = async() => {
    ...
    try {
      ...
      const response = await deleteWarehouse(data, 1)
